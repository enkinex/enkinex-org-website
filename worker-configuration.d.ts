/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.local` (hash: 5e202308b571ac4694e69c5933f0adc2)
// Runtime types generated with workerd@1.20260430.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENKINEX_PROJECT_DIR: string;
		ENKINEX_WEBSITE_PROJECT_DIR: string;
		ENKINEX_WEBSITE_DATABASE_DIR: string;
		SURREAL_DATA: string;
		SURREAL_HOST: string;
		SURREAL_USER: string;
		SURREAL_PASS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENKINEX_PROJECT_DIR" | "ENKINEX_WEBSITE_PROJECT_DIR" | "ENKINEX_WEBSITE_DATABASE_DIR" | "SURREAL_DATA" | "SURREAL_HOST" | "SURREAL_USER" | "SURREAL_PASS" | "SURREAL_NAMESPACE" | "SURREAL_DATABASE">> {}
}
